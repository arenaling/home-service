...
describe('Agency API:', function () {
  ...
  describe('GET /api/agencies', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/agencies').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        agencys = res.body;
  ...
  describe('POST /api/agencies', function () {
    beforeEach(function (done) {
      (0, _supertest2.default)(app).post('/api/agencies').send({
        name: 'New Agency',
  ...
  describe('GET /api/agencies/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/agencies/' + newAgency._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        agency = res.body;
  ...
  describe('PUT /api/agencies/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).put('/api/agencies/' + newAgency._id).send({
        name: 'Updated Agency',
  ...
  describe('DELETE /api/agencies/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2.default)(app).delete('/api/agencies/' + newAgency._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when agency does not exist', function (done) {
      (0, _supertest2.default)(app).delete('/api/agencies/' + newAgency._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=agency.integration.js.map
